...
def gold():
    ...
    # Read data
    dates = pd.date_range('2010-11-01', '2014-09-23')
...
def gold2():
    ...
    # Read data
    dates = pd.date_range('2015-11-01', '2018-09-23')
    ...
    #Scatterplot XAU vs NUGT
    daily_returns.plot(kind='scatter', x='XAU', y='NUGT')
    # Polynomial fit of degree 1. Require x and y coordinate. 
    # Returns polynomial coefficient and y intercept. In y = mx + b, m and b respectively 
    beta_NUGT, alpha_NUGT = np.polyfit(daily_returns['XAU'], daily_returns['NUGT'], 1)
    print "beta_NUGT=", beta_NUGT
    print "alpha_NUGT=", alpha_NUGT
    plt.plot(daily_returns['XAU'], beta_NUGT*daily_returns['XAU'] + alpha_NUGT, '-', color='r')
    plt.show()
